 ...
 */
package com.mycompany.postinvoicegenerator;
...
protected static double toPPI(double inch)
  ...
  {    
      ...
      int r= itemName.size();
      ImageIcon icon=new ImageIcon("D:\\New folder\\POSTInvoiceGenerator\\src\\main\\java\\com\\mycompany\\postinvoicegenerator\\company.jpg"); 
      int result = NO_SUCH_PAGE;    
        ...
        try{
           ...
           // int headerRectHeighta=40;
            ...
            g2d.drawString("     Bhagwan Enterprises.com       ",12,y);y+=yShift;
            g2d.drawString("   25 Punawama Wazirganj ",12,y);y+=yShift;
            g2d.drawString("   Gaya BIHAR ",12,y);y+=yShift;
            g2d.drawString("   www.facebook.com/Aaruhi verma ",12,y);y+=yShift;
            g2d.drawString("        +8271293749      ",12,y);y+=yShift;
            ...
            g2d.drawString("*************************************",10,y);y+=yShift;
            g2d.drawString("       SOFTWARE BY:Aarushi verma         ",10,y);y+=yShift;
            g2d.drawString("   CONTACT: aarushiwaz789@gmail.com      ",10,y);y+=yShift;       
